...
class DBWNode(object):
	...
	def __init__(self):
		...
		self.controller = Controller(wheel_base, steer_ratio, max_lat_accel, max_steer_angle, vehicle_mass, wheel_radius, fuel_capacity, accel_limit, decel_limit)
	...
	def loop(self):
		...
		while not rospy.is_shutdown():
			...
			throttle, brake, steer = self.controller.control(self.dbw_enabled,self.cur_lin_vel,self.cur_ang_vel,self.des_lin_vel, self.des_ang_vel)
			#throttle = 1.0
			#brake = 0.0
			#steer = 0.0
